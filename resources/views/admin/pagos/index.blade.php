        ...
        @foreach($pagos as $pago)
            <tr>
                ...
                <td data-label="Acciones">
                    <a href="/admin/pagos/edit/{{$pago->id}}">
                        <button class="btn btn-warning">
                            <i class="fa fa-pencil"></i>
                            <span></span>
                        </button>
                    </a>
                    <a href="/admin/pagos/delete/{{$pago->id}}" onclick="return confirm('¿Desea eliminar permanentemente el pago?')">
                        <button class="btn btn-danger">
                            <i class="fa fa-trash"></i>
                            <span></span>
                        </button>
                    </a>
                    <a href="/admin/pagos/user/{{$pago->id}}">
